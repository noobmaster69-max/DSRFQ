...
# <name>.old-web-20260924-1058 and the new one copied in. The app keeps running
# the old code from memory until OneZera-Web restarts.
$ErrorActionPreference = 'Stop'
$stage  = 'C:\Aizera\Staging\web-20260924-1058'
$web    = 'C:\Aizera\DSRFQ\DSRFQ.Web'
$backup = 'C:\Aizera\Backup\web-20260924-1058'
...
foreach ($rel in $files) {
    ...
    try {
        ...
        $aside = "$target.old-web-20260924-1058"
