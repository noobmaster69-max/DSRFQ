...
[ConnectionKey("Default"), Module("Master"), TableName("MasterWeightUnits")]
[DisplayName("Weight Units"), InstanceName("Weight Units")]
...
[LookupScript("MasterWeightUnits",Permission = "?")]
public sealed class WeightUnitsRow : LoggingRow<WeightUnitsRow.RowFields>, IIdRow, INameRow
{
