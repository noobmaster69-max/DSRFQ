import {
    Culture, DataGrid, Decorators, Dictionary, Fluent, GridUtils, Grouping, IGetEditValue, ISetEditValue, SlickFormatting, SlickTreeHelper, ToolButton, WidgetProps, count, getRemoteDataAsync, stripDiacritics, toGrouping, tryGetText,
...
import "./PermissionCheckEditor.css";
...
@Decorators.registerEditor('DSRFQ.Administration.PermissionCheckEditor', [IGetEditValue, ISetEditValue])
