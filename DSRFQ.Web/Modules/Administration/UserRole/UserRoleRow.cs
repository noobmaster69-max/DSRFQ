...
public sealed partial class UserRoleRow : Row<UserRoleRow.RowFields>, IUserRoleRow
{
    ...
    Field IUserRoleRow.UserIdField => fields.UserId;
    StringField IUserRoleRow.RoleKeyOrNameField => fields.RoleKeyOrName;
}